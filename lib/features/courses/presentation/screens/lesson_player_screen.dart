                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("Mathematics")
                                  .extrabold(color: AppColors.fontColor, size: 12.sp),

                              SizedBox(height: 4.h),

                              Text("12 Chapters")
                                  .extrabold(color: AppColors.fontColor, size: 11.sp),
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 8.w),
                                  Text("70%", style: TextStyle(fontSize: 10.sp)),
                                ],
                              ),
